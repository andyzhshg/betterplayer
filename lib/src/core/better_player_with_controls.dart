          ...
          Center(
            child: ClipRect(
              child: SizedBox(
                ...
                child: FittedBox(
                  fit: betterPlayerController.getFit(),
                  child: SizedBox(
                    width: betterPlayerController.videoPlayerController?.value.size?.width ?? 0,
                    height: betterPlayerController.videoPlayerController?.value.size?.height ?? 0,
                    child: betterPlayerController.betterPlayerConfiguration.overlay ?? Container(),
                  ),
                ),
              ),
            ),
